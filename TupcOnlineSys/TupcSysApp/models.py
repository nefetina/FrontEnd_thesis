...
class register1(AbstractUser):
    ...
    Personal_description = models.CharField(
        max_length=40, null=True, default="")
...
class Schedule_lab(models.Model):
    lubnum = models.CharField(max_length=100, null=False)
    lmon = models.CharField(max_length=100, null=True, default="")
    ltue = models.CharField(max_length=100, null=True, default="")
    lwed = models.CharField(max_length=100, null=True, default="")
    lthu = models.CharField(max_length=100, null=True, default="")
