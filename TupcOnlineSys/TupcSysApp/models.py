...
class Schedule(models.Model):
    l1mon = models.CharField(max_length = 100, null=True)
    l1tue = models.CharField(max_length = 100, null=True)
    l1wed = models.CharField(max_length = 100, null=True)
    l1thurs = models.CharField(max_length = 100, null=True)
    l1fri = models.CharField(max_length = 100, null=True)
    l1sat = models.CharField(max_length = 100, null=True)
    l2mon = models.CharField(max_length = 100, null=True)
    l2tue = models.CharField(max_length = 100, null=True)
    l2wed = models.CharField(max_length = 100, null=True)
    l2thurs = models.CharField(max_length = 100, null=True)
    l2fri = models.CharField(max_length = 100, null=True)
    l2sat = models.CharField(max_length = 100, null=True)
    l3mon = models.CharField(max_length = 100, null=True)
    l3tue = models.CharField(max_length = 100, null=True)
    l3wed = models.CharField(max_length = 100, null=True)
    l3thurs = models.CharField(max_length = 100, null=True)
    l3fri = models.CharField(max_length = 100, null=True)
    l3sat = models.CharField(max_length = 100, null=True)