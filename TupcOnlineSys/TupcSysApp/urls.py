...
urlpatterns =[
    ...
    path('employeeID_dl/', views.employeeID_dl, name='employeeID_dl'), 
    path('internetStudent_dl/', views.internetStudent_dl, name='internetStudent_dl'), 
    path('wifiStudent_dl/', views.wifiStudent_dl, name='wifiStudent_dl'),
    path('Borrower_dl/', views.Borrower_dl, name='Borrower_dl'),
    path('wifiFaculty_dl/', views.wifiFaculty_dl, name='wifiFaculty_dl'),
